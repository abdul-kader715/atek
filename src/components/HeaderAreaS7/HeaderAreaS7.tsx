...
interface HeaderAreaS7Props {
    className?: string;
}

const HeaderAreaS7: FC<HeaderAreaS7Props> = (props) => {
    const ClickHandler = () => {
                    ...
                    <div className="menu-area">
                        <div className="container th-container3">
                            <div className="row align-items-center justify-content-between">
                                ...
                                <div className="col-auto">
                                    <div className="header-right-button d-xl-block d-none">
                                        <span 
