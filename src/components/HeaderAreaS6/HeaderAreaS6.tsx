...
interface HeaderAreaS6Props {
    className?: string;
}

const HeaderAreaS6: FC <HeaderAreaS6Props> = (props) => {
    const ClickHandler = () => {
                    ...
                    <div className="menu-area">
                        <div className="header-button">
                            <span 
                                ...
                                className="simple-btn sideMenuToggler d-none d-xl-block"
                                role="button"
                                tabIndex={0}
                        ...
                        <div className="widget">
                            <div className="th-widget-about">
                                ...
                                <div className="th-social">
                                    <a target="_blank" href="https://www.facebook.com/" rel="noopener noreferrer"><i className="fab fa-facebook-f"></i></a>
                                    <a target="_blank" href="https://www.twitter.com/" rel="noopener noreferrer"><i className="fab fa-twitter"></i></a>
                                    <a target="_blank" href="https://www.linkedin.com/" rel="noopener noreferrer"><i className="fab fa-linkedin-in"></i></a>
                                    <a target="_blank" href="https://www.whatsapp.com/" rel="noopener noreferrer"><i className="fab fa-whatsapp"></i></a>
                        ...
                        <div className="widget">
                            ...
                            <div className="recent-post-wrap">
                                <div className="recent-post d-flex align-items-center">
                                    ...
                                    <div className="media-body">
                                        ...
                                        <h4 className="post-title">
                                            <Link className="text-inherit" onClick={ClickHandler} to="/blog-details/1">
                                ...
                                <div className="recent-post d-flex align-items-center">
                                    <div className="media-img">
                                        <Link onClick={ClickHandler} to="/blog-details/1">
                                            <img src={recent2} alt="Blog Image" />
                                        </Link>
                                    </div>
                                    <div className="media-body">
                                        <div className="recent-post-meta">
