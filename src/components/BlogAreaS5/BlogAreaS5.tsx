...
interface BlogAreaS5Props {
  className?: string;
}

const BlogAreaS5: FC<BlogAreaS5Props> = (props) => {
  const ClickHandler = () => {
        ...
        <div className="row gx-24 gy-30">
          {BlogData.slice(4, 5).map((item, index) => (
            <div className="col-xl-4" key={index}>
              <div className="blog-grid3 th-ani">
                <div className="blog-img global-img">
                  <img src={item.imageUrl7} alt="blog image" />
                </div>
          ...
          <div className="col-xl-8">
            {BlogData.slice(5, 6).map((item, index) => (
              <div className="blog-grid3 style2 th-ani" key={index}>
                <div className="blog-img global-img">
                  <img src={item.imageUrl7} alt="blog image" />
                </div>
                <div className="blog-grid_content">
            ...
            {BlogData.slice(6, 7).map((item, index) => (
              <div
                className="blog-grid3 th-ani style2 mt-24"
                key={index}
              >
                <div className="blog-img global-img">
