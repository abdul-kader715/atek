...
interface HeaderAreaS5Props {
    className?: string;
    SearchBtn?: boolean;
}

const HeaderAreaS5: FC<HeaderAreaS5Props> = (props) => {
    const ClickHandler = () => {
                            ...
                            <div className="row align-items-center justify-content-between">
                                ...
                                <div className="col-auto">
                                    <div className="header-button d-none d-xl-block">
                                        ...
                                        <Link onClick={ClickHandler} to="/contact" className="th-btn white-btn th-icon">
