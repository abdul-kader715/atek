...
interface HeaderAreaS3Props {
    className?: string;
    SearchBtn?: boolean;
}

const HeaderAreaS3 = (props: HeaderAreaS3Props) => {
    const ClickHandler = () => {
        ...
        <div id='scroll'>
                        ...
                        <div className="container">
                            <div className="row align-items-center justify-content-between">
                                <div className="col-auto d-none d-xl-block">
                                    {SearchBtn && (
                                        <button type="button" className="icon-btn icon-svg searchBoxToggler" onClick={toggleSearch}>
                                ...
                                <div className="col-auto">
                                    <div className="header-button">
                                        <button type="button" onClick={toggleSideBar} className="simple-icon sideMenuToggler d-none d-xl-block">
                                            <img src={Sidebar} alt="" />
                                        </button>
            ...
            {SearchOpen && (
                <div className={`popup-search-box ${SearchOpen ? 'show' : ''}`}>
                    <button className="searchClose" onClick={toggleSearch}><i className="fal fa-times"></i></button>
                    <form onSubmit={(e) => {
                        e.preventDefault();
                    }}>
