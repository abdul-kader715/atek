...
import Logowhith from '../../img/logo4.svg';
...
interface HeaderAreaS9Props {
  className?: string;
}

const HeaderAreaS9: FC<HeaderAreaS9Props> = (props) => {
  const ClickHandler = () => {
              ...
              <div className="row align-items-center justify-content-between">
                ...
                <div className="col-auto d-none d-xl-block">
                  <div className="header-button">
                    <Link onClick={ClickHandler} to="/contact" className="th-btn style2 th-radius th-icon">
