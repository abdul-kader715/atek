...
const BlogArea: FC<BlogAreaProps> = ({ className }) => {
   const ClickHandler = () => {
   ...
   return (
      <section className={`${className || ""}`} id="blog-sec">
            ...
            <div className="mb-30 text-center text-md-start">
               <div className="row align-items-center justify-content-between">
                  ...
                  <div className="col-md-auto scroll-text-animation" data-animation="fade_from_bottom">
                     <Link onClick={ClickHandler} to="/blog" className="th-btn style4 th-icon">
                     ...
                     <SwiperSlide key={index}>
                        <div className="blog-box th-ani">
                           ...
                           <div className="blog-box_content">
                              ...
                              <Link onClick={ClickHandler} to={`/blog-details/${Blog.slug}`} className="th-btn style4 th-icon">
         ...
         <ShapeMockup className="shape-mockup shape1 d-none d-xxl-block" bottom="5%" left="3%">
            <img src={shape2} alt="shape" />
         </ShapeMockup>

         <ShapeMockup className="shape-mockup shape2 d-none d-xl-block" top="28%" right="5%">
