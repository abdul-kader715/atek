...
import menu_bg from '../../img/menu_bg_mask.png';
...
const HeaderArea: FC<HeaderAreaProps> = (props) =>{
    const ClickHandler = () => {
                            ...
                            <div className="row align-items-center justify-content-between">
                                ...
                                <div className="col-auto d-none d-xl-block">
                                    <div className="header-button">
                                        <Link onClick={ClickHandler} to="/contact" className="th-btn white-btn th-icon">Get In Touch <i className="fa-light fa-arrow-right-long"></i></Link>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <MaskedDiv className='logo-bg bg-mask' maskSrc={logo_bg} />
                        <MaskedDiv className='menu-right-bg' maskSrc={menu_bg} />
                    </div>
                </div>
            </header>
