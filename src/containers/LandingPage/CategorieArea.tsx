...
const productSlides: ProductSlide[] = [
  { img: cate1, link: 'https://themeforest.net/item/cigma-multipurpose-business-consulting-html-template/56550644?s_rank=6' },
  { img: cate2, link: 'https://themeforest.net/item/atek-it-solution-technology-figma-template/56737794?s_rank=4' },
  { img: cate3, link: 'https://themeforest.net/item/rotal-hotel-resort-booking-html-template/56740194?s_rank=3' },
  { img: cate4, link: 'https://themeforest.net/item/piller-real-estate-figma-template/56976401?s_rank=2' },
  { img: cate5, link: 'https://themeforest.net/item/robor-ai-and-automation-integration-figma-template/56978233?s_rank=1' },
  { img: cate3, link: 'https://themeforest.net/item/rotal-luxury-hotel-booking-figma-template/56568873?s_rank=5' },
  { img: cate1, link: 'https://themeforest.net/user/themehour/portfolio' },
  { img: cate2, link: 'https://themeforest.net/user/themehour/portfolio' },
  { img: cate3, link: 'https://themeforest.net/user/themehour/portfolio' },
  { img: cate4, link: 'https://themeforest.net/user/themehour/portfolio' },
  { img: cate5, link: 'https://themeforest.net/user/themehour/portfolio' },
  { img: cate3, link: 'https://themeforest.net/user/themehour/portfolio' },
];

const LatestProductsSlider: FC = () => {
  return (
        ...
        <div className="categorie-wrapp position-relative text-center text-xl-start d-xl-flex justify-content-between align-items-center">
          ...
          <div className="slider-area categorie-slider">
            <Swiper
              ...
              className="swiper th-slider text-end"
              id="innerSlider1"
            >
